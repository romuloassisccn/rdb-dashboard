...
const floorConfigs: FloorConfig[] = [
  ...
  },
  {
    ...
    zones: [
      ...
      { id: "C3", title: "C3 · VAV 48", sensors: ["vav_48"], maskSrc: "/zone-masks-3pav/C3.png", label: { x: 1215, y: 225 } },
      { id: "E3", title: "E3 · VAV 50", sensors: ["vav_50"], maskSrc: "/zone-masks-3pav/E3.png", label: { x: 270, y: 420 } },
      { id: "F3", title: "F3 · VAV 51", sensors: ["vav_51"], maskSrc: "/zone-masks-3pav/F3.png", label: { x: 565, y: 515 } },
      { id: "G3", title: "G3 · VAV 52 / VAV 47", sensors: ["vav_52", "vav_47"], maskSrc: "/zone-masks-3pav/G3.png", label: { x: 1135, y: 465 } },
    ],
    guide: {
